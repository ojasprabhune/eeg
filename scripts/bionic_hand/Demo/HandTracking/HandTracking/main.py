    ...
    if results.multi_hand_landmarks:
        for index, handedness_classif in enumerate(results.multi_handedness):
            ...
            if handedness_classif.classification[0].score > 0.8:
                ...
                tip2_x = hand_landmarks.landmark[mp_hands.HandLandmark.MIDDLE_FINGER_TIP].x - \
                    hand_landmarks.landmark[mp_hands.HandLandmark.MIDDLE_FINGER_MCP].x
                tip2_y = hand_landmarks.landmark[mp_hands.HandLandmark.MIDDLE_FINGER_TIP].y - \
                    hand_landmarks.landmark[mp_hands.HandLandmark.MIDDLE_FINGER_MCP].y
                tip2_z = hand_landmarks.landmark[mp_hands.HandLandmark.MIDDLE_FINGER_TIP].z - \
                    hand_landmarks.landmark[mp_hands.HandLandmark.MIDDLE_FINGER_MCP].z

                tip3_x = hand_landmarks.landmark[mp_hands.HandLandmark.RING_FINGER_TIP].x - \
                    hand_landmarks.landmark[mp_hands.HandLandmark.RING_FINGER_MCP].x
                tip3_y = hand_landmarks.landmark[mp_hands.HandLandmark.RING_FINGER_TIP].y - \
                    hand_landmarks.landmark[mp_hands.HandLandmark.RING_FINGER_MCP].y
                tip3_z = hand_landmarks.landmark[mp_hands.HandLandmark.RING_FINGER_TIP].z - \
                    hand_landmarks.landmark[mp_hands.HandLandmark.RING_FINGER_MCP].z

                tip4_x = hand_landmarks.landmark[mp_hands.HandLandmark.THUMB_TIP].x - \
                    hand_landmarks.landmark[mp_hands.HandLandmark.THUMB_MCP].x
                tip4_y = hand_landmarks.landmark[mp_hands.HandLandmark.THUMB_TIP].y - \
                    hand_landmarks.landmark[mp_hands.HandLandmark.THUMB_MCP].y
                tip4_z = hand_landmarks.landmark[mp_hands.HandLandmark.THUMB_TIP].z - \
                ...
                origin = np.array([hand_landmarks_norm.landmark[mp_hands.HandLandmark.WRIST].x, hand_landmarks_norm.landmark[mp_hands.HandLandmark.WRIST].y,
                                  # wrist base as the origin
                                   hand_landmarks_norm.landmark[mp_hands.HandLandmark.WRIST].z])
                mid_mcp = np.array([hand_landmarks_norm.landmark[mp_hands.HandLandmark.MIDDLE_FINGER_MCP].x, hand_landmarks_norm.landmark[mp_hands.HandLandmark.MIDDLE_FINGER_MCP].y,
                ...
                pinky_mcp = np.array([hand_landmarks_norm.landmark[mp_hands.HandLandmark.PINKY_MCP].x, hand_landmarks_norm.landmark[mp_hands.HandLandmark.PINKY_MCP].y,
                                     # base of the pinky finger
                                      hand_landmarks_norm.landmark[mp_hands.HandLandmark.PINKY_MCP].z])

                index_mcp = np.array([hand_landmarks_norm.landmark[mp_hands.HandLandmark.INDEX_FINGER_MCP].x, hand_landmarks_norm.landmark[mp_hands.HandLandmark.INDEX_FINGER_MCP].y,
                ...
                if handedness_classif.classification[0].label == 'Right':
                    r_res = [{'r_tip1': tip1, 'r_tip2': tip2,
                              'r_tip3': tip3, 'r_tip4': tip4}]
                elif handedness_classif.classification[0].label == 'Left':
                    l_res = [{'l_tip1': tip1, 'l_tip2': tip2,
                              'l_tip3': tip3, 'l_tip4': tip4}]
