...
def plot_scaling_laws():
    ...
    plt.plot(fractions, lin_4_f1, marker='o', linestyle='-', linewidth=2, label='Linear Baseline 4 classes')
    
    # plot Linear Baseline 4 classes
    plt.plot(fractions, lin_3_f1, marker='s', linestyle='-', linewidth=2, label='Linear Baseline 3 classes')
